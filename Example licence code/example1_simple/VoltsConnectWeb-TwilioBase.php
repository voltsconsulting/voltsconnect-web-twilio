<?php
class VoltsConnectWeb-TwilioBase {
	public $key = "ECBABCE8CE806F23";
	private $product_id = "7";
	private $product_base = "Volts-Connect-Web-Twilio";
	private $server_host = "https://lic.volts-consulting.com/wp-json/lice/";
	/* @var self*/
